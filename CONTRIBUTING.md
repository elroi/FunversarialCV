...
- **Copy and brand:** [docs/BRAND_COMMUNICATION_STRATEGY.md](docs/BRAND_COMMUNICATION_STRATEGY.md) (voice, scope, trust messaging); [docs/brand-guide.json](docs/brand-guide.json) (machine-readable checklist for plans and agents—keep in sync with the strategy doc).
