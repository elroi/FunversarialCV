...
3. **Upload and inject eggs** – Demo CV (Clean · DOCX) loaded; Inject Eggs showed injecting state; success state with Download and Re-process observed. Duality Monitor stages and terminal log updated as expected.
