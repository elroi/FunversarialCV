...
3. **Upload and harden** – Demo CV (Clean · DOCX) loaded; Harden showed processing state; success state with Download and Re-process observed. Duality Monitor stages and terminal log updated as expected.
